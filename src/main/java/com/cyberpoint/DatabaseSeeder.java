...
public class DatabaseSeeder implements CommandLineRunner {
  ...
  private List<Product> seedProducts() {
    ...
    Product product = new Product("Cadeira gamerrrrr", 1500d, "Cadeira ergometrica", "electronic",
        "https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcRA8skCQjfadR_IwFKCbHBIQGOglbKGOESbkBGxE7w64Sy1wa7SWHBRSM4cd1bdWOYQu6cQLOuFCIyPjwuVU_Zb0AExrSxPubrYDlDTCsyw9xE-WwvIHAN9&usqp=CAE", 10L);
